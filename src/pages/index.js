...
const IndexPage = () => {
  return (
    <>
      <section className="h-screen  overflow-hidden bg-no-repeat bg-cover bg-center bg-fixed bg-[url('../images/Hello_3.png')] flex justify-center items-end pb-28 mx-auto">
        <Link
